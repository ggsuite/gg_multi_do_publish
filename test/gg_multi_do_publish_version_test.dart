...
void main() {
  group('gg_multi_do_publish_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_multi_do_publish_version.dart');
